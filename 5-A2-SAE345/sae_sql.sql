...
INSERT INTO adresse(id_adresse, utilisateur_id, nom, adresse, code_postal, ville, favori) VALUES
(NULL, 2, 'Paul', '2 rue de la liberté', 69000, 'Lyon', 1),
(NULL, 3, 'Pierre', '3 rue de la fraternité', 13000, 'Marseille', 1);
...
(NULL,2, 2, 'Parfait, le casque est confortable', '2020-01-02', 1),
(NULL, 3, 4, 'Le casque a l\'air solide. La livraison était rapide !', '2019-06-14', 0),
(NULL, 3, 15, 'Parfait', '2023-09-16', 1),
(NULL,2, 6, 'La livraison a pris plus d\'un mois... et la couleur n\'est pas la même que sur la photo', '2021-05-25', 1),
(NULL, 1, 2, 'Merci pour votre commentaire', '2020-01-10', 1),
(NULL, 1, 6, 'Nous sommes navrés que la couleur ne soit pas la même. Nous améliorerons nos services grâce à votre commentaire', '2021-05-29', 0),
(NULL, 1, 4, 'Merci pour votre commentaire', '2020-01-10', 1),
(NULL,2, 1, 'Très bon casque, léger et confortable.', '2020-08-06', 1),
(NULL, 2, 2, 'Bonne qualité, mais la taille est un peu juste.', '2023-08-07', 1),
...
(NULL, 3, 7, 'Prix très abordable, fait le job.', '2023-10-10', 1),
...
(NULL, 3, 17, 'Parfait pour les trajets quotidiens.', '2023-03-20', 1),
(NULL, 2,14, 'Casque militaire robuste et confortable, parfait pour les longues missions.', '2024-03-25', 1),
(NULL, 2, 10, 'Très confortable, parfait pour mes sorties en montagne!', '2020-12-15', 1),
